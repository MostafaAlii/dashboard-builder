        ...
        <div class="navbar-header">
            <ul class="nav navbar-nav flex-row">
                <li class="nav-item mobile-menu d-lg-none mr-auto">
                    <a class="nav-link nav-menu-main menu-toggle hidden-xs" href="{{  route(get_guard_name() . '.dashboard')  }}">
                        <i class="ft-menu font-large-1"></i>
                    </a>
                </li>
                <li class="nav-item mr-auto">
                    <a class="navbar-brand" href="{{ route(get_guard_name() . '.dashboard')  }}">
                        <img class="brand-logo" alt="{{ trans('dashboard.dashboard') }}" src="{{ asset('app-assets/images/logo/logo.png') }}">
                        <h3 class="brand-text">{{ trans('dashboard.dashboard') }}</h3>
                    </a>
                </li>
                        ...
                        <ul class="mega-dropdown-menu dropdown-menu row p-1">
                            ...
                            <li class="col-md-5 px-2">
                                ...
                                <ul class="row mt-2">
                                    ...
                                    <li class="col-6 col-xl-4"><a class="text-center mb-2 mb-xl-3" href="#" target="_blank"><i class="la la-plane font-large-1 mr-0"></i>
                                            <p class="font-medium-2 mt-25 mb-0">Travel</p>
                                        </a></li>
                                    <li class="col-6 col-xl-4"><a class="text-center mb-2 mb-xl-3 mt-75 mt-xl-0" href="#" target="_blank"><i class="la la-stethoscope font-large-1 mr-0"></i>
                                            <p class="font-medium-2 mt-25 mb-0">Hospital</p>
                                        </a></li>
                                    <li class="col-6 col-xl-4"><a class="text-center mb-2 mt-75 mt-xl-0" href="#" target="_blank"><i class="la la-bitcoin font-large-1 mr-0"></i>
                                            <p class="font-medium-2 mt-25 mb-50">Crypto</p>
                                        </a></li>
                                    <li class="col-6 col-xl-4"><a class="text-center mb-2 mt-75 mt-xl-0" href="#" target="_blank"><i class="la la-tag font-large-1 mr-0"></i>
                                            <p class="font-medium-2 mt-25 mb-50">Support</p>
                                        </a></li>
                                    <li class="col-6 col-xl-4"><a class="text-center mb-2 mt-75 mt-xl-0" href="#" target="_blank"><i class="la la-bank font-large-1 mr-0"></i>
                    ...
                    <li class="dropdown dropdown-user nav-item">
                        <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                            ...
                            <span class="avatar avatar-online">
                                <img src="{{ asset('app-assets/images/portrait/small/avatar-s-19.png') }}" alt="{{get_user_data()?->name}}">
                                <i></i>
                            </span>
                        </a>
